...
class ShelfController extends Controller
{
    ...
    public function store(ShelfRequest $request)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_create_shelf', $e);
        }
    }
    ...
    public function update(ShelfRequest $request, $id)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_update_shelf', $e);
        }
    }
    ...
    public function destroy(Shelf $shelf)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_delete_shelf', $e);
        }
    }
    ...
    private function errorResponse($messageKey, Exception $e)
    {
        return response()->json([
            'result' => false,
            'message' => __('messages.shelf.' . $messageKey),
