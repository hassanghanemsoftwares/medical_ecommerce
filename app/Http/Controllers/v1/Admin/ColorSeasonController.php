...
class ColorSeasonController extends Controller
{
    ...
    public function store(ColorSeasonRequest $request)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_create_color_season', $e);
        }
    }
    ...
    public function update(ColorSeasonRequest $request, $id)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_update_color_season', $e);
        }
    }
    ...
    public function destroy(ColorSeason $colorSeason)
    {
        try {
            ...
            DB::rollBack();
            return $this->errorResponse('failed_to_delete_color_season', $e);
        }
    }
    ...
    private function errorResponse($messageKey, Exception $e)
    {
        return response()->json([
            'result' => false,
            'message' => __('messages.color_season.' . $messageKey),
